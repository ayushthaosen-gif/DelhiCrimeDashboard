...
#resetMapBtn { font: inherit; font-size: 12px; padding: 6px 10px; border-radius: 6px; border: 1px solid var(--border); background: var(--bg); color: var(--text); cursor: pointer; }
#resetMapBtn:hover { border-color: var(--amber); }
...
<div id="topbar">
  ...
  <div style="flex-basis:100%; display:flex; gap:10px; flex-wrap:wrap;" id="pointLayerToggles">
