...
**The SLL exception**: Special and Local Laws did not follow the IPC/BNS decline. Across the dashboard's 15 territorial police districts, registered SLL cases rose from **18,998 in 2023 to 21,065 in 2024 (+10.9%)**. The increase was concentrated rather than uniform: Shahdara (+595), North-East (+401), Outer North (+401), Rohini (+374), and West (+297) together account for almost the entire net citywide rise. Nor did every conventional-crime indicator fall: burglary increased from 6,911 to 8,956 (+29.6%), even as theft (-22.4%), robbery (-9.2%), and total IPC/BNS (-16.1%) declined.

SLL is a different basket from IPC/BNS crime. It includes regulatory and enforcement statutes covering excise, narcotics, gambling, information technology, public-property defacement, arms, passports, and many other laws. In NCRB's broader Delhi category table -- which also includes specialist reporting units outside the dashboard's 15 territorial districts -- the largest upward movements include public-property-defacement, Excise Act, Information Technology Act, foreigners-registration, and gambling cases. That makes the SLL increase consistent with more recorded regulatory/enforcement cases while conventional IPC/BNS totals fall; it does **not**, by itself, establish that underlying public safety improved or deteriorated. See the original [2023 SLL workbook](https://www.ncrb.gov.in/uploads/files/2DistrictwiseSLLCrimes2023.xlsx) and [2024 SLL workbook](https://www.ncrb.gov.in/uploads/files/2DistrictwiseSLLCrimes2024.xlsx).
