...
async function main() {
  ...
  const outputPath = path.join(__dirname, 'data', 'delhi_crime_2016_2021_verified.json');
  ...
  const harmonizedPath = path.join(__dirname, 'data', 'delhi_crime_2016_2021_harmonized.json');
